  ...
  return (
    <main>
      <div className="mx-auto max-w-[640px] px-5 py-20 text-center md:px-8 md:py-28">
        <p className="font-body text-[10px] uppercase tracking-[0.2em] text-muted">Porudžbina primljena</p>
        ...
        <div className="mt-10 border border-line bg-surface px-6 py-6 text-left">
          <p className="font-body text-[10px] uppercase tracking-[0.16em] text-muted">Pitanja?</p>
