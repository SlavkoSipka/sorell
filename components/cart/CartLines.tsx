...
function QuantityStepper({ line }: { line: CartLine }) {
  ...
  return (
    <div className="inline-flex items-center rounded-card border border-line">
      ...
      <span className="min-w-[24px] text-center font-body text-[12px] tabular-nums text-ink">
        {line.quantity}
      </span>
      <button
        type="button"
            ...
            <div className="min-w-0 flex-1">
              ...
              {line.packageLabel ? (
                <p className="mt-1 font-body text-[12px] text-muted">
                  <span className="text-[10px] uppercase tracking-[0.12em]">Pakovanje</span>
                  <span className="px-1.5">·</span>
                  {line.packageLabel}
                </p>
              ) : null}
              <p className="mt-1 font-body text-[12px] text-muted tabular-nums">
              ...
              <div className="mt-3 flex items-center gap-3">
                ...
                <button
                  ...
                  className="font-body text-[11px] text-muted underline underline-offset-2 hover:text-ink"
                >
                  Ukloni
                </button>
              </div>
